...
class RegisterC extends StatefulWidget {
  ...
  @override
  State<RegisterC> createState() => RegisterCState();
}
class RegisterCState extends State<RegisterC> {
                  ...
                  children: [
                    Padding(
                      ...
                      child: AnimatedTextKit(
                        ...
                        animatedTexts: [
                          ColorizeAnimatedText("Register",textStyle: TextStyle(color: Color(0XFF6C06DB),fontFamily: 'NerkOne',fontSize: 40,fontWeight: FontWeight.bold,fontStyle: FontStyle.italic),colors: colorizeColors),
                        ],
                        onTap: () {
                        },
                        repeatForever: true,
                    ...
                    Padding(
                      ...
                      child: TextInput(inputText:  "Create your Password",onClick: (value){setState(() {
                        e_message="";
                      });pass = value;},pass: true,coloring: Colors.white,),
                    ),
                    Text(
                      e_message,
                      style: TextStyle(
